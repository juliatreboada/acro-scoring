...
export const ManualScoresModal = {
    ...
    saving: 'Saving…',
    saved: 'Scores saved.',
    savedWithResults: 'Scores saved — visible on results page and judge panels.',
    savedWithTv: 'Scores saved — visible on results, judge panels, and TV scoreboard.',
    saveFailed: 'Could not save scores.',
    resultStatusLabel: 'Result status',
    resultStatusHint: 'Definitive appears on the public results page. Provisional is for judges only until confirmed.',
    queueOnTv: 'Show on TV scoreboard now',
    queueOnTvHint: 'Queues this team on the TV screen. Definitive also reveals the score immediately.',
...
export const DJReview = {
    ...
    motion: 'Motion',
    link: 'Link',
    legsTogetherHandstand: 'Legs together (+1)',
    ...
    diffLimits: 'D limits',
    diffLimitMax: 'max',
    diffLimitExceeded: 'exceeds limit',
    diffRatioExceeded: 'B:D ratio exceeds 2:1',
  }
...
export const AccreditationsTab = {
  ...
  typeJudge: 'Judge',
  typeStaff: 'Staff',
  staffSection: 'Staff (manually added)',
  ...
  searchPlaceholder: 'Filter by name or club…',
}
