...
export const ManualScoresModal = {
    ...
    savedWithResults: 'Puntuaciones guardadas — visibles en resultados y paneles de jueces.',
    savedWithTv: 'Puntuaciones guardadas — visibles en resultados, paneles de jueces y TV.',
    saveFailed: 'No se pudieron guardar las puntuaciones.',
    resultStatusLabel: 'Estado del resultado',
    resultStatusHint: 'Definitiva aparece en la página pública de resultados. Provisional solo para jueces hasta confirmar.',
    queueOnTv: 'Mostrar en el marcador TV ahora',
    queueOnTvHint: 'Pone este equipo en la pantalla TV. Definitiva también revela la nota al instante.',
...
export const AccreditationsTab = {
  ...
  typeJudge: 'Juez/a',
  typeStaff: 'Staff',
  staffSection: 'Staff (añadido manualmente)',
  staffNamePlaceholder: 'Nombre completo',
  addStaff: 'Añadir',
  deleteStaff: 'Eliminar',
  uploadPhoto: 'Subir foto',
  noStaff: 'Sin miembros de staff añadidos.',
  acreditaciones: 'Acreditaciones',
...
export const TVTab = {
    ...
    moveDown:     'Abajo',
    // ranking mode
    previewScore:       'PUNTUACIÓN',
    previewRanking:     'RANKING',
    live:               'EN DIRECTO',
    switchToRanking:    'Cambiar a Ranking →',
    switchToScore:      '← Cambiar a Puntuación',
    rankingConfig:      'Configuración del Ranking',
    saveRankingConfig:  'Guardar',
    durationSeconds:    'Segundos por ranking',
    bgColor:            'Color de fondo',
    rankingSlots:       'Rankings a mostrar',
    generateFromSessions: 'Generar desde sesiones',
    noSlots:            'Sin rankings. Pulsa "Generar desde sesiones".',
  }
