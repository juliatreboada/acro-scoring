...
import { printLicencias } from '@/lib/printParticipants'
...
export default function LicenciasTab({ lang, competitionStatus, competitionName, competitionLogoUrl, provisionalEntries, definitiveEntries, globalTeams, clubs, entries, competitionGymnasts, competitionCoaches, globalCoaches, ageGroupRules }: Props) {
...
function NominativeView({ lang, globalTeams, clubs, entries, competitionGymnasts, competitionCoaches, globalCoaches, ageGroupRules, competitionName, competitionLogoUrl }: Omit<Props, 'competitionStatus' | 'provisionalEntries' | 'definitiveEntries'>) {
  const t = useT('LicenciasTab', lang)
  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-end mb-2">
        <button
          onClick={() => printLicencias({ competitionName, logoUrl: competitionLogoUrl, entries, teams: globalTeams, clubs, coaches: registeredCoaches, gymnasts: competitionGymnasts, ageGroupRules })}
