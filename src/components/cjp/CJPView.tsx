      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 min-h-0">
        ...
        {isReviewMode && reviewPerf ? (
          <>
            ...
            {/* score grid — re-open switches to active scoring; edit stays in review */}
            <ScoreGrid
              scores={reviewScores}
            ...
            {/* update / confirm — only for provisional results */}
            {isCJP && reviewResult?.status === 'provisional' && (
              <div className="flex gap-2">
                <button
                  onClick={handleUpdateProvisional}
                ...
                <button
                  onClick={handleConfirmFinalFromReview}
